...
<div id="slideshow"><!-- static image -->
  <div class="slideshow container clearfix">
    <a href="#"><img src="<?php print base_path() . drupal_get_path('theme', 'magazeenlite')?>/images/slide1.png" alt="" /></a>
...
<div id="link-back">
  <div class="container clearfix">
    <div id="footer-message" style="clear:both;">
      <div class="description">Copyright 2014 by Innovation University</div>
